...
RECENT_YEAR_RESEARCH_ALGORITHM_SCOPE: Final = (
    "chanlun-v3-recent-year-sector-technical-research/v1"
)
...
RECENT_YEAR_RESEARCH_ALGORITHM_PATHS: Final = (
    ...
    "src/chanlun/decision_support/trading_system/v3_etf_proxy_facts.py",
    ...
    "src/chanlun/decision_support/trading_system/v3_recent_year_provenance.py",
    "src/chanlun/decision_support/trading_system/v3_recent_year_research.py",
    "src/chanlun/decision_support/trading_system/v3_sector_first_scope.py",
    "src/chanlun/decision_support/trading_system/v3_sector_first_trigger_plan.py",
    "src/chanlun/decision_support/trading_system/v3_sector_strength_replay.py",
