...
This is deliberately separate from the immutable V3 live specification.  It
...
RECENT_YEAR_RESEARCH_SCHEMA = "chanlun-v3-recent-year-current-sector-research/v1"
