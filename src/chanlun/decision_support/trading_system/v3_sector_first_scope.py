"""Point-in-time, sector-first A-share scope for the V3 individual path.

The live QMT GICS catalog is useful for a prospective screen, but it has no
effective-dated history.  Historical V3 evaluation therefore uses the QMT
...
SECTOR_FIRST_SCOPE_SCHEMA = "chanlun-v3-sector-first-scope/v1"
