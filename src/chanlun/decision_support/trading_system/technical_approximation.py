...
class TechnicalApproximationParameters:
    ...
    schema: str = "chanlun-technical-point-approximation-parameters"
...
class TechnicalApproximationAlignmentContract:
    ...
    schema: str = "chanlun-technical-point-approximation-alignment"
    contract_id: str = "APPROXIMATE_30M_5M_1M_CONFIRMED_POINTS"
...
class ApproximateChanlunEntryChain:
    ...
    def l2_confirmation_bar_high(self) -> Decimal:
        """Shared chain-interface price used by the candidate builder."""
