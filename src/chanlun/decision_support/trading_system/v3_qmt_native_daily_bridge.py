...
The V3 specification requires 5m/30m bars to be aggregated from one
...
def build_qmt_native_daily_bridge(
    *,
    ...
    trading_calendar_revision = sha256_json(
        {
            "schema": "chanlun-qmt-native-daily-trading-calendar-prefix/v1",
    ...
    native_content_revision = sha256_json(
        {
            "schema": "chanlun-qmt-native-daily-visible-prefix/v1",
            "symbol": symbol,
            "observed_at": observed,
            "price_basis": {
