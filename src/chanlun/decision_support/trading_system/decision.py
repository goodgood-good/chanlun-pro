...
class DecisionIntent:
    ...
    def __post_init__(self) -> None:
        ...
        if self.live_status != LIVE_STATUS:
            raise ValueError("strict strategy decisions cannot enable live trading")
...
class DecisionCore:
    ...
    def decide(self, facts: DecisionInput) -> DecisionIntent:
        ...
        if not facts.health.healthy:
            ...
            return _intent(
                ...
                rule_id="PRIORITY_01_OPERATIONS_HALT",
                priority=1,
                reasons=failed,
            )
        if not facts.all_structure_inputs_completed:
            return _intent(
                facts,
                action="NO_TRADE",
                rule_id="COMPLETED_STRUCTURE_ONLY",
                priority=1,
        ...
        if facts.strategic.trading_continuity_lost:
            return _intent(
                ...
                rule_id="PRIORITY_02_TRADING_CONTINUITY_LOST",
                priority=2,
        ...
        if facts.strategic.existing_persistent_exit:
            return _intent(
                facts,
                action="STRATEGIC_EXIT_INTENT",
                rule_id="PRIORITY_03_CONTINUE_PERSISTENT_EXIT",
                priority=3,
                quantity=0 if ledger is None else ledger.q_current,
                target=0,
                persistence="PERSISTENT_EXIT",
        ...
        if exit_reasons:
            return _intent(
                facts,
                action="STRATEGIC_EXIT_INTENT",
                rule_id="PRIORITY_04_STRATEGIC_FULL_EXIT",
                priority=4,
                quantity=0 if ledger is None else ledger.q_current,
                target=0,
                persistence="PERSISTENT_EXIT",
        ...
        if facts.strategic.l0_upmove_divergence and ledger is not None:
            ...
            if target == 0:
                return _intent(
                    facts,
                    action="STRATEGIC_EXIT_INTENT",
                    rule_id="PRIORITY_05_DIVERGENCE_TARGET_ZERO_EXIT",
                    priority=5,
            ...
            return _intent(
                ...
                rule_id="PRIORITY_05_STRATEGIC_REDUCE_HALF",
                priority=5,
        ...
        if tactical.l1_third_sell and ledger is not None:
            ...
            return _intent(
                ...
                rule_id="PRIORITY_06_L1_THIRD_SELL",
                priority=6,
                quantity=quantity,
        ...
        if tactical.l1_third_buy and ledger is not None and ledger.pending_restore_qty > 0:
            ...
            return _intent(
                ...
                rule_id="PRIORITY_07_L1_THIRD_BUY_PROTECTION",
                priority=7,
                quantity=quantity,
        ...
        if (
            ...
            return _intent(
                ...
                rule_id="PRIORITY_08_THIRD_SELL_RECOVERY",
                priority=8,
                quantity=quantity,
                persistence="OPTIONAL" if quantity else "NONE",
        ...
        if tactical.ordinary_sell_signal and ledger is not None:
            ...
            return _intent(
                ...
                rule_id="PRIORITY_09_ORDINARY_TACTICAL_SELL",
                priority=9,
                quantity=quantity,
                persistence="OPTIONAL" if quantity else "NONE",
        ...
        if tactical.ordinary_buyback_signal and ledger is not None:
            ...
            return _intent(
                ...
                rule_id="PRIORITY_10_ORDINARY_TACTICAL_BUYBACK",
                priority=10,
                quantity=quantity,
                persistence="OPTIONAL" if quantity else "NONE",
        ...
        if candidate is not None and candidate.accepted:
            ...
            if eligible_state and facts.q_plan > 0:
                return _intent(
                    facts,
                    action="ENTRY_INTENT",
                    rule_id="PRIORITY_11_STRATEGIC_ENTRY",
                    priority=11,
        ...
        return _intent(
            facts,
            action="WAIT",
            rule_id="PRIORITY_12_WAIT",
            priority=12,
            reasons=entry_reasons,
        )


def decide_live(facts: DecisionInput) -> DecisionIntent:
    return DecisionCore().decide(facts)


def decide_backtest(facts: DecisionInput) -> DecisionIntent:
    return DecisionCore().decide(facts)
