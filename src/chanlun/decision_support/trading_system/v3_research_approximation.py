...
The unique V3 specification correctly says that the original Chanlun lessons
...
class ResearchApproximationParameters:
    schema: str = "chanlun-v3-qmt-research-approximation-parameters/v1"
...
class ResearchApproximationLedger:
    ...
    schema: str = "chanlun-v3-qmt-research-approximation-ledger/v1"
    data_grade: str = "RESEARCH_APPROXIMATION"
    highest_status: str = "RESEARCH_ONLY"
    live_status: str = "LIVE_DISABLED"
