"""Point-in-time QMT sector trigger facts for the V3 individual-stock path.
...
class SectorTriggerSnapshot:
    ...
    def __post_init__(self) -> None:
        ...
        if self.source_frequency != "30m":
            raise ValueError("V3 sector trigger frequency is frozen at 30m")
...
def build_sector_trigger_snapshot(
    *,
    ...
    membership_revision = sha256_json(
        {
            "schema": "chanlun-v3-qmt-sector-membership/v1",
            "source": source,
    ...
    document = {
        "schema": "chanlun-v3-sector-trigger/v1",
        "symbol": symbol,
        "sector_id": assessment.sector_id,
