...
TRADING_SESSION_EVIDENCE_SCHEMA = (
    "chanlun-v3-qmt-trading-session-evidence/v1"
)
OFFICIAL_TRADING_SESSION_EVIDENCE_SCHEMA = (
    "chanlun-v3-official-trading-session-evidence/v1"
)
OFFICIAL_CALENDAR_SOURCE_SCHEMA = (
    "chanlun-official-a-share-calendar-source/v1"
)
...
_PINNED_OFFICIAL_SOURCE_FINGERPRINTS = {
    "SSE-ANNOUNCEMENT-2025-45": (
        "sha256:3bdfe6112278242f64aef533b0f0ae5fef896f86890168548a89271e8a26d44f"
    ),
}
