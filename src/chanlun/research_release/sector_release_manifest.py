"""Content-addressed publication binding for the strict strategy sector research result.
...
SECTOR_RELEASE_MANIFEST_SCHEMA = "chanlun-sector-release-manifest"
SECTOR_RESEARCH_ARTIFACT_SCHEMA = (
    "chanlun-sector-first-full-market-research-backtest"
)
TERMINAL_QUERY_PLAN_SCHEMA = "chanlun-sector-first-terminal-query-plan"
DIRECT_EXTRACT_MANIFEST_SCHEMA = "chanlun-sector-first-direct-extract"
CATALOG_LEDGER_SCHEMA = "chanlun-qmt-sector-capture-ledger"
...
def _verify_direct_manifest(
    ...
    *,
    ...
    if direct.get("schema") != DIRECT_EXTRACT_MANIFEST_SCHEMA:
        raise SectorReleaseManifestError("direct manifest must be immutable strict strategy")
    if (
