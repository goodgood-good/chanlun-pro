...
_STRICT_BASE_CONFIG: dict[str, object] = {'fractal_rule': 'three-cl-k-both-extremes',
 ...
 'segment_gap_rule': 'second-feature-fractal-completes-parent-and-successor-v2',
 ...
 'segment_feature_pivot_rule': 'reference-local-first-break-and-origin-extreme-retest-v3',
 'segment_reverse_break_rule': 'first-break-contained-stem-with-distinct-price-and-pivot-sources-v6',
 ...
 'segment_tail_rule': 'latest-equal-extreme-preview-with-existing-directional-fallback-v1',
 'segment_confirmation_rule': 'all-source-pens-through-causal-witness-v2',
 'segment_scan_rule': 'shared-first-feature-suffixes-with-local-search-outcomes-v6',
