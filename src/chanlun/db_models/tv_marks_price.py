...
class TableByTVMarksPrice(Base):
    """TradingView 价格主图标记表 (cl_tv_marks_price)，对应 TV marks 接口在价格轴上显示的标注点。"""
    ...
    mark_text = Column(String(100), comment="提示")
    mark_label = Column(String(2), comment="标签")
    mark_label_font_color = Column(String(20), comment="标签字体颜色")
    mark_min_size = Column(Integer, comment="最小尺寸")
