...
def build_matrix() -> dict[str, Any]:
    ...
    no_future_policy = v7_summary.get("no_future_policy") or {}
    ...
    cascade_ok = (
        str(cascade.get("signals", "")).endswith("_v7_registry_hit_signals.csv")
        and int(cascade.get("min_level") or 0) >= 1
        and all(
            (item.get("event") or {}).get("bs_type") != "3sell"
    ...
    rows = [
        ...
        },
        {
            ...
            "status": "pass" if v7_no_future_ok else "gap",
            ...
            "evidence": [
                ...
                "D:/chanlun_pro/reports/us_tsla_mtf3_wffull_window_upgrade_l0min3_include_l0_v7_registry_hit_summary.json",
                "D:/chanlun_pro/reports/us_tsla_mtf3_wffull_window_upgrade_l0min3_include_l0_v7_registry_hit_signals.csv",
            ],
            "finding": "" if v7_no_future_ok else "Latest v7 summary does not prove the strict no-future policy.",
        },
        {
            ...
            "finding": "" if cascade_ok else "Cascade report is stale or not based on v7 continuous-registry signals.",
        },
        {
        ...
        },
        {
            ...
            "evidence": [
                "D:/chanlun_pro/reports/us_tsla_mtf3_wffull_window_upgrade_l0min3_include_l0_v7_registry_hit_summary.json",
                "D:/chanlun_pro/reports/us_tsla_mtf3_20260601_0610_v7_registry_layered_summary.json",
                "D:/chanlun_pro/reports/us_core3_mtf3_20260601_0610_v7_registry_layered_summary.json",
                ...
                "D:/chanlun_pro/reports/live_backtest_signal_cache_prewarm_tsla_v7_registry_manifest.json",
                "D:/chanlun_pro/reports/live_backtest_signal_cache_prewarm_tsla_202606_v7_registry_manifest.json",
                "D:/chanlun_pro/reports/live_backtest_signal_cache_prewarm_qqq_202606_v7_registry_manifest.json",
                "D:/chanlun_pro/reports/live_backtest_signal_cache_prewarm_nvda_202606_v7_registry_manifest.json",
                "D:/chanlun_pro/reports/live_backtest_signal_cache_prewarm_core3_202606_v7_registry_manifest.json",
                "D:/chanlun_pro/reports/live_backtest_signal_checkpoints_v7_l0min3_registry_core3_202606",
                "src/chanlun/recursive_bt/strategy_optimizer.py",
            ],
            "finding": (
                "The best strict original-registry report currently has "
                f"{int(robustness.get('best_strict_original_registry_trade_count') or _summary_value(v7_summary, 'trade_count') or 0)} "
                ...
                "not final proof, unless they are regenerated with complete v7 continuous registry."
            ),
        },
    ]
