...
from chanlun.decision_support.trading_system.v3_sector_first_direct_facts import (
...
def test_direct_facts_expand_only_a_triggered_sector_and_keep_three_program_closed(
    ...
    monkeypatch.setattr(
        ...
        "v3_sector_first_direct_facts.load_qmt_frame",
    ...
    monkeypatch.setattr(
        "chanlun.decision_support.trading_system."
        "v3_sector_first_direct_facts.final_confirmed_structure_events",
        causal,
    )
