...
def test_recent_year_replay_contract_uses_stock_rules_without_three_program() -> None:
    ...
    assert "sector_trigger" in V3_SECTOR_TECHNICAL_REQUIRED_CANDIDATE_GATES
    assert "industry_opportunity" not in V3_SECTOR_TECHNICAL_REQUIRED_CANDIDATE_GATES
    assert "fundamental_role" not in V3_SECTOR_TECHNICAL_REQUIRED_CANDIDATE_GATES
    assert "relative_value" not in V3_SECTOR_TECHNICAL_REQUIRED_CANDIDATE_GATES
