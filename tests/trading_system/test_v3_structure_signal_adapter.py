...
def point(
    ...
    *,
    ...
    return StructuralPoint(
        ...
        price_basis_revision="pit-adjusted:v1",
        tower="formal",
...
def test_adapter_maps_only_explicit_completed_v3_structure_signals() -> None:
    l0_third_sell = point(
        "l0:3sell",
        frequency="30m",
        point_type="3sell",
    ...
    ledger = build_v3_structure_signal_ledger(
        symbol=SYMBOL,
...
def test_appending_future_frozen_facts_cannot_change_prior_signal_rows() -> None:
    ...
    prefix = build_v3_structure_signal_ledger(
        symbol=SYMBOL,
        l0_points=(first,),
        l1_points=(),
        l2_points=(),
    ...
    full = build_v3_structure_signal_ledger(
        symbol=SYMBOL,
