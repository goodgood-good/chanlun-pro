...
def l0_point() -> StructuralPoint:
    return StructuralPoint(
        ...
        price_basis_revision="revision:test",
        tower="formal",
        recursive_level=0,
        anchor_at=at(11, 55),
...
def align(**changes):
    ...
    return align_independent_entry_chains(**values)[0]


def test_alignment_uses_center_leave_and_return_not_point_anchor_window() -> None:
    decision = align()
