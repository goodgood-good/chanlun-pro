...
DEFAULT_MANIFEST = Path(
    ...
    "csi300_broad_pool_market_database_manifest.json"
)
DEFAULT_SOURCES = {
    "159919.SZ": Path(
        ".cache/chanlun_159919/financial_data_query_bars.sqlite3"
    ),
    "159925.SZ": Path(
        ".cache/chanlun_159925/financial_data_query_bars.sqlite3"
    ),
    "510300.SH": Path(
        ".cache/chanlun_available_data/financial_data_query_bars.sqlite3"
    ),
    "510310.SH": Path(
        ".cache/chanlun_csi300_etfs/financial_data_query_bars.sqlite3"
    ),
    "510330.SH": Path(
        ".cache/chanlun_510330/financial_data_query_bars.sqlite3"
    ),
    "510360.SH": Path(
        ".cache/chanlun_510360/financial_data_query_bars.sqlite3"
    ),
    "510380.SH": Path(
        ".cache/chanlun_510380/financial_data_query_bars.sqlite3"
    ),
    "510390.SH": Path(
        ".cache/chanlun_510390/financial_data_query_bars.sqlite3"
    ),
}
...
def main() -> int:
    ...
    manifest: dict[str, object] = {
        "schema": "chanlun-csi300-broad-pool-cache",
