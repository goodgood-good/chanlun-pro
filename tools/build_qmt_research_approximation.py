...
DEFAULT_SCOPE = Path("audit/chanlun_live_integration/sector_first_full_market_scope.json")
DEFAULT_PIT = Path(
...
def _canonical_scope_hash(
    *,
    ...
    ``audit_sector_first_scope.py`` deliberately appends the current-GICS
...
def _observation(
    *,
    ...
    source_revision = sha256_json(
        {
            "schema": "chanlun-qmt-research-observation-source",
            "code": code,
