#!/usr/bin/env python3
"""Independently review serialized direct-recursive V3 artifacts."""
...
PRESCREEN = INTEGRATION / "direct_recursive_v3_etf_prescreen.json"
BACKTEST = INTEGRATION / "direct_recursive_v3_component_backtest.json"
DATA_AUDIT = INTEGRATION / "direct_recursive_v3_data_acceptance.json"
CORE = INTEGRATION / "direct_recursive_v3_authorized_core_verification.json"
PROTECTED = INTEGRATION / "v31_protected_input_verification.json"
OUTPUT = INTEGRATION / "direct_recursive_v3_independent_review.json"
...
def review() -> dict[str, object]:
    ...
    document: dict[str, object] = {
        "schema": "chanlun-v3-direct-recursive-independent-review/v1",
        "passed": passed,
