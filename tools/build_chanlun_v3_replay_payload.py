#!/usr/bin/env python3
"""Build and run strict V3 ReplayBatch payloads from frozen real-fact artifacts."""
...
from chanlun.decision_support.trading_system.v3_replay_payload_builder import (
    build_v3_replay_payload,
)
from tools.backtest_chanlun_v3_multisymbol_events import run_payload
...
DEFAULT_PRESCREENS = (
    Path("audit/chanlun_live_integration/v31_cached_symbol_prescreen_159919.json"),
    Path("audit/chanlun_live_integration/v31_cached_symbol_prescreen_159925.json"),
    Path("audit/chanlun_live_integration/v31_cached_symbol_prescreen_510300.json"),
    Path("audit/chanlun_live_integration/v31_cached_symbol_prescreen_510310.json"),
    Path("audit/chanlun_live_integration/v31_cached_symbol_prescreen_510330.json"),
    Path("audit/chanlun_live_integration/v31_cached_symbol_prescreen_510360.json"),
    Path("audit/chanlun_live_integration/v31_cached_symbol_prescreen_510380.json"),
    Path("audit/chanlun_live_integration/v31_cached_symbol_prescreen_510390.json"),
)
...
DEFAULT_CORPORATE_ACTIONS = Path(
    "audit/chanlun_live_integration/qmt_csi300_etf_corporate_actions_v1.json"
)
DEFAULT_BUILD_OUTPUT = Path(
    "audit/chanlun_live_integration/strict_v3_replay_payload_build.json"
)
DEFAULT_PAYLOAD_OUTPUT = Path(
    "audit/chanlun_live_integration/strict_v3_replay_payload.json"
)
DEFAULT_REPLAY_OUTPUT = Path(
    "audit/chanlun_live_integration/strict_v3_multisymbol_replay.json"
)
