"""Safely promote one verified V3 sector candidate to the stable release.
...
STABLE_MANIFEST = FORMAL_ROOT / "v3_release_manifest.json"
SCHEMA = "chanlun-v3-sector-release-promotion/v1"
