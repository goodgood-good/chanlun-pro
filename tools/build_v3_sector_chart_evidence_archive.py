...
DEFAULT_COVERAGE = Path(
    "audit/chanlun_live_integration/v3_sector_first_full_market_1m_coverage.json"
)
...
def _calendar_sessions(
    *,
    ...
    revision = sha256_json(
        {
            "schema": "chanlun-sector-chart-market-calendar/v1",
...
def build(args: argparse.Namespace) -> dict[str, object]:
    ...
    for sector_id, review_as_of_unix in point_keys:
        ...
        entry_id = sha256_json(
            {
                "schema": "chanlun-v3-sector-chart-evidence-entry/v1",
