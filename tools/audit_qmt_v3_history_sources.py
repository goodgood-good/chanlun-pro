#!/usr/bin/env python3
"""Audit QMT historical sector membership and tick availability for V3.
...
from tools.chanlun_v3_research_data import atomic_json, content_sha256  # noqa: E402


CN = ZoneInfo("Asia/Shanghai")
DEFAULT_OUTPUT = Path(
    "audit/chanlun_live_integration/qmt_v3_history_source_audit.json"
)
...
def collect_qmt_history_audit(
    *,
    ...
    stable: dict[str, object] = {
        "schema": "chanlun-v3-qmt-history-source-audit/v1",
