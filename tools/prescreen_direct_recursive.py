#!/usr/bin/env python3
"""Prescreen the primary 30m/5m/1m direct-recursive strict strategy structure path.
...
from chanlun.decision_support.trading_system.structure_signal_adapter import (  # noqa: E402
...
def _instrument_report(
    *,
    ...
    signal_ledger = build_structure_signal_ledger(
        symbol=code,
