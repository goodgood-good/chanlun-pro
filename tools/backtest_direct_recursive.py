#!/usr/bin/env python3
"""Run the shared strict strategy replay engine for the direct-recursive prescreen.
...
def _validate_prescreen(payload: dict[str, object]) -> None:
    if payload.get("schema") != "chanlun-direct-recursive-etf-prescreen":
...
def build_backtest(
    ...
    *,
    ...
    report: dict[str, object] = {
        "schema": "chanlun-direct-recursive-component-backtest",
