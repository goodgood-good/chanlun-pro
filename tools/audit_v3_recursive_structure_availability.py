#!/usr/bin/env python3
"""Audit whether frozen one-minute structure proves the strict v3 L0/L1/L2 chain."""
...
def audit(
    *,
    ...
    result: dict[str, object] = {
        "schema": "chanlun-v3-recursive-structure-availability/v2",
        ...
        "required_v3_levels": {"L2": 0, "L1": 1, "L0": 2},
        ...
        "strict_v3_entry_fact_types_available": entry_types_observed,
        "decision": decision,
        "reason": reason,
